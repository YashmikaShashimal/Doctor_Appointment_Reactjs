      ...
      <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        <div className='flex items-center gap-4 mb-8 text-gray-500'>
          <label htmlFor='doc-img'>
            <img className='w-16 bg-gray-100 cursor-pointer rounded-all' src={docImg ? URL.createObjectURL(docImg) : assets.upload_area} />
          </label>
        ...
        <div className='flex flex-col items-start gap-10 text-gray-600 lg:flex-row'>
          <div className='flex flex-col w-full gap-4 lg:flex-1'>
            ...
            <div className='flex flex-col flex-1 gap-1'>
              <p>Experience</p>
              <select onChange={(e)=>setExperience(e.target.value)} value={experience} className='px-3 py-2 border rounded' name='' >
        ...
        <button type='submit' className='px-6 py-3 mt-4 bg-white rounded-full text-primary hover:text-white hover:bg-primary ring-2 ring-primary hover:scale-105'>Add doctor</button>
      </div>
