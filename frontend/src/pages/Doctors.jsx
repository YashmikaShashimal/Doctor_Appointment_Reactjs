...
import { AppContext } from '../context/AppContextt'
    ...
    <div>
      ...
      <div className='flex flex-col items-start gap-5 mt-5 sm:flex-row'>
        <div className='flex flex-col gap-4 text-sm text-gray-600'>
          ...
          <p onClick={()=> speciality === 'Gynecologist' ? navigate('/doctors') : navigate('/doctors/Gynecologist')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointe ${speciality === "Gynecologist" ? "bg-indigo-100 text-black" : ""}r ${speciality === "" ? "bg-indigo-100 text-black" : ""}`}>Gynecologist</p>
