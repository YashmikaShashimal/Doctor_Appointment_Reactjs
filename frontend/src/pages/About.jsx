    ...
    <div>
      ...
      <div className='flex flex-col gap-12 my-10 md:flex-row'>
        ...
        <div className='flex flex-col justify-center gap-6 text-sm text-gray-600 md:w-2/4'>
          <p>Welcome to E-Channeling, Your trusted partner in managing your healthcare needs conveniently and efficiently.At Prescripto, We understand the challanges indivituals face when it comes to schrduling doctor appointment and managing their health record.</p>
          <p>E-Channeling is Commited to excellence in healthcare technology.We Continuodly dtrive to enhance our flatform, Intergrating the laytest advancements to improve user experience and deliver superior service.Whether You're Booking Your first appointment or managinf ongooing care, E-Channeling is here to support you every step of the day.</p>
          <b className='text-gray-800'>Our Vision</b>
          <p>Our Vision at E-Channeling is to create a seamiess healthcare ecperience for every user.We aim to bridge the Gop between patients and healthcare providers.Making it easier for you to access the care you need,When You Need it.</p>
        </div>
      </div>
